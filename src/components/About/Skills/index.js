import './index.scss'
import { faJava, faCss3, faHtml5, faJsSquare, faPython } from '@fortawesome/free-brands-svg-icons'
import { faCircle as faCircleSolid} from '@fortawesome/free-solid-svg-icons'
import { faCircle } from '@fortawesome/free-regular-svg-icons'
import '../../../assets/images/cpp.svg'
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
import AnimatedLetters from '../../AnimatedLetters'
import { useState, useEffect } from 'react'

// TODO
// Do something about formatting of code: too many repeats
...
const Skills = () => {
    ...
    return (
        ...
        <div className="skills">
            <h2>
                <AnimatedLetters letterClass={letterClass} strArray={skillsArray} idx={23} />
            </h2>
            <ul>
                <li>
                    <FontAwesomeIcon className='language-icon' icon={faPython} color="#4B8BBE"/>  
                    <svg 
